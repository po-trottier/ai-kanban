...
/**
 * Attachment picker for the CREATE form: the card doesn't exist yet, so files
 * are gathered locally (name + remove) and uploaded by NewCardButton once the
 * card is created. Mirrors the detail-panel dropzone but lists pending files
 * instead of server thumbnails.
 */
