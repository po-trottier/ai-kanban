...
export function SettingsPage() {
  ...
  // manage* permission in the active policy (default-deny otherwise) — the same
  // gate the header gear uses, so the two never disagree.
  if (policy.data !== undefined && !canManageAnything(policy.data, me.role)) {
    return (
