 ...
 * 7-lane workflow is seeded, never reshaped at runtime. Gated by the
 * `manageLanes` permission of the active policy (ADR-013), and every change
 * publishes the board-scoped `lane.updated` hint (ADR-008).
 */
