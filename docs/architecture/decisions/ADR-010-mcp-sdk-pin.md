...
(Verified July 2026.) The MCP spec revision finalized 2026-07-28 changes Streamable HTTP
(GET stream endpoint and protocol-level sessions removed, SEP-2567). The TypeScript SDK v2
...
- Pin **@modelcontextprotocol/sdk 1.29.x** (exact), Streamable HTTP transport.
