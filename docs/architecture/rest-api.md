...
| Method & path                                                                                          | Role           | Description                                                                                                                                                                                                                                                                                                                                                                                                                 |
| ------------------------------------------------------------------------------------------------------ | -------------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| POST /lanes                                                                                            | `manageLanes`  | add a column at the end: body `{ label, wipLimit? }`; the machine `key` is a slug derived from the label (201)                                                                                                                                                                                                                                                                                                              |
| PATCH /lanes/:id                                                                                       | `manageLanes`  | edit label / WIP limit (403 `permission:manageLanes`)                                                                                                                                                                                                                                                                                                                                                                       |
| POST /lanes/reorder                                                                                    | `manageLanes`  | rewrite column order: body `{ orderedIds }` must list every lane exactly once (409 otherwise); returns the reordered lanes                                                                                                                                                                                                                                                                                                  |
| DELETE /lanes/:id                                                                                      | `manageLanes`  | remove ANY column, seeded or admin-added (204); 409 if it is the board's last remaining column or still holds cards (move its cards out first), 404 unknown                                                                                                                                                                                                                                                                 |
